...
flow:
  ...
  inputs:
    ...
    - SACorePassword:
        ...
        required: false
        sensitive: true
    - SASoftwarePolicyName: PostgreSQL16
    - SoftwareMajorVersion: '16'
    - SoftwareName: postgresql
    - SilentCommand:
        default: '--mode unattended --unattendedmodeui none'
        required: false
  ...
  workflow:
        ...
        loop:
          do_external:
            f1dafb35-6463-4a1b-8f87-8aa748497bed:
              ...
              - matchTo: '${getOldUnitFileName}'
              - ignoreCase: 'false'
          for: getOldUnitFileName in oldUnitFileName
          break:
            - success
        navigate:
          - success: SUCCESS
        ...
        do_external:
          15aa115d-c0ed-4712-982d-eeb7365fe456:
            ...
            - corePassword:
                ...
                sensitive: true
            - coreVersion: '${saCoreVersion}'
            - unitNames: '${SASoftwarePolicyName}'
        publish:
          - importedUnitFileNames: '${unitFileName}'
          - newUnitType: '${unitType}'
          - importNewUnitNames: '${name}'
          - newUnitFileName: '${unitFileName}'
        navigate:
    ...
    - GET_NEW_UNIT:
        loop:
          for: importedUnitName in importNewUnitNames
          do:
  ...
  graph:
    steps:
      ...
      GET_NEW_UNIT:
        ...
        'y': 1040
        navigate:
          eccb351e-56b4-9777-badf-b2ba52f326d8:
            targetId: 2962e0db-83bf-42e3-ca86-7708a3f5875d
            port: FAILURE
      Get_SA_Version:
        x: 40
